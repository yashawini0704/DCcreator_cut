    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
      ...
      <div className="text-center mb-12">
        <div className="flex items-center justify-center space-x-3 mb-4">
          ...
          <h1 className="text-5xl font-bold text-white tracking-wide">Competition Results</h1>
        </div>
        <p className="text-gray-300 text-xl">Live rankings based on community votes</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="bg-gradient-to-br from-gray-800 to-slate-800 rounded-xl p-6 text-center shadow-2xl border border-gray-700">
          ...
          <div className="text-gray-300">Film Votes</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-gray-800 to-slate-800 rounded-xl p-6 text-center shadow-2xl border border-gray-700">
          ...
          <div className="text-gray-300">Song Votes</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <section>
          <div className="flex items-center space-x-3 mb-8">
            ...
            <h2 className="text-4xl font-bold text-white tracking-wide">Films Leaderboard</h2>
          </div>
        ...
        <section>
          <div className="flex items-center space-x-3 mb-8">
            ...
            <h2 className="text-4xl font-bold text-white tracking-wide">Songs Leaderboard</h2>
          </div>
      ...
      {(sortedFilms[0]?.votes > 0 || sortedSongs[0]?.votes > 0) && (
        <section className="mt-16">
          <div className="text-center mb-8">
            <h2 className="text-4xl font-bold text-white mb-4 tracking-wide">🏆 Current Winners 🏆</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {sortedFilms[0]?.votes > 0 && (
              <div className="bg-gradient-to-br from-amber-500/20 to-yellow-500/20 rounded-2xl p-8 border border-amber-500/30 shadow-2xl">
                <div className="text-center mb-6">
                  ...
                  <div className="text-gray-300">from {sortedFilms[0].center}</div>
            ...
            {sortedSongs[0]?.votes > 0 && (
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl p-8 border border-purple-500/30 shadow-2xl">
                <div className="text-center mb-6">
                  ...
                  <div className="text-gray-300">from {sortedSongs[0].center}</div>
